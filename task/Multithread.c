...
(JNIEnv *a, jobject b)
{
	printf("From JNI, PID : %d, TID : %d\n ", getpid(),(pid_t)syscall(__NR_gettid));
	return;
}
...
static char *gen_events = "cycles:u";
...
JNIEXPORT void JNICALL Java_Multithread_lbrRecord (JNIEnv * a , jobject b )
{
